...
# ============================================================
EXPERIMENT = "08_earlystop_lr_scheduler_alignment"
ALIGNMENT = "callbacks"  # changed to exactly one factor in experiments 01-08
SEEDS = [42, 123, 2026]
...
def run_sanity_check() -> None:
    ...
    print(f"batch={images.shape} output={output.shape} parameters={model.count_params():,} finite=True")
